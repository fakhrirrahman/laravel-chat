                    ...
                    <div class="flex flex-col h-[600px]">
                            ...
                            @foreach ($messages as $msg)
                                <div class="flex items-start space-x-3">
                                    <div
                                        ...
                                        <span
                                            class="text-white text-sm font-medium">{{ substr($msg->user->name, 0, 1) }}</span>
                                    </div>
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2">
                                            <span class="font-semibold text-gray-900">{{ $msg->user->name }}</span>
                                            <span
                                                class="text-xs text-gray-500">{{ $msg->created_at->diffForHumans() }}</span>
                                        </div>
                        ...
                        <div class="p-4 border-t border-gray-200 bg-white">
                            <form id="chat-form" class="flex items-end space-x-3">
                                <div class="flex-1">
                                    <x-text-input id="message" type="text" class="w-full"
                                        placeholder="Type your message..." wire:ignore />
                                </div>
